package mg.nomenjanahary.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "mg.nomenjanahary.repositories",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "mg.nomenjanahary.model" });
